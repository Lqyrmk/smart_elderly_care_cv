                ...
                for i, det in enumerate(pred):
                    ...
                    if len(det):
                        ...
                        if t - self.alert_count_time >= 5:
                            ...
                            # 提交
                            session.flush()
                            cv2.imwrite('utils/file_cos_utils/img/fall/' + str(cv_event.event_id) + '.jpg', im0)
                            # 提交
                            session.commit()
                            # 关闭session
                            session.close()
                            ...
                            # 上传到cos
                            # 要上传图片所在的文件夹
                            local_dir_path = 'utils/file_cos_utils/img/fall'
                            # 图片对应的path，对应上传到的文件夹
                            ...
                            # cv2.imwrite('utils/file_cos_utils/img/fall/' + time_str + '.jpg', im0)
